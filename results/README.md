...
**E1-gpt4o-shuffle (§5.3):** GPT-4o coax, clean (original key) vs clean-shuffled, paired at the item level. Position robustness: **content-stable 61.4%**, **answered-by-position (letter-stable) 17.0%**, **neither 21.6%** (n=453); shuffled accuracy 48.3% vs clean 53.6% (~5 pt drop). Generator `paper_analysis/position_stability.py`. Reuses the coax-clean answers from the whole-491 run + this clean-shuffled run. Claude/Gemini rows to follow.
