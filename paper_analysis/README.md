...
| **§5.3.1** (**Table 5.3**) GPT-4o revised-prompt accuracy + 95% CI + guess-one-letter floor, original key vs shuffled key (491), and the 5.3-pt drop | `paper_analysis/shuffle_drop.py` | `results/closed_ended/gpt-4o-2024-11-20__coax-direct-k0__whole__n491.csv` (original key) + `results/closed_ended/position_bias/gpt-4o-2024-11-20__coax-direct-k0__shuffled__n491.csv` (shuffled key) | `_generated/shuffle_drop_table.md`, `_generated/shuffle_drop.values.json` |
